...
$url = 'http://www.foreverafter.ro/invitatii-de-nunta/handmade/';
$content = file_get_contents($url);
$first_step = explode( '<ul class="list_produse">' , $content );
...
<p>Vezi mai multe invitatii <a href="http://foreverafter.ro">aici</a></p>
</section>
